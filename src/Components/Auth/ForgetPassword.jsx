...
function ForgetPassword() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.post("http://localhost:4100/api/Password-change-request", formData);
    ...
    const handleOTPSubmit = async (otpevent) => {
        ...
        setLoading(true); // Set loading to true when the request starts
        try {
            const response = await axios.post(`http://localhost:4100/api/Verify-Otp/${formData.email}/${formData.newPassword}`, formData);
            console.log(response.data);
            toast.success(response.data.msg);
    ...
    const resendOTP = async (otpevent) => {
        ...
        setLoading(true); // Set loading to true when the request starts
        try {
            const response = await axios.post(`http://localhost:4100/api/resend-sign-Otp/`, formData);
            console.log(response.data);
