...
function FinalCart() {
  ...
  const handleSubmit = async (e) => {
    ...
    const userInfo = JSON.parse(sessionStorage.getItem('userInfo')); // Assuming you store user info in sessionStorage
    ...
    try {
      const response = await axios.post('http://localhost:4100/api/Make-Orders', combinedOrder);
